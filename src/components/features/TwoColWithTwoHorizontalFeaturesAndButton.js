...
export default ({
  ...
  description = "Customer satisfaction is our paramount goal, driving every decision we make to ensure a positive and fulfilling experience for our valued customers.",

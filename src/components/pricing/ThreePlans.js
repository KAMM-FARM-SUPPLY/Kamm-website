...
export default ({
  ...
  description = "Try out the most selling products with our trusted customers for this period.These prices have discounted and some of the benefits laid out.",
  plans = null,
